...
func (q *Queries) GetAdminByID(ctx context.Context, id pgtype.UUID) (Administration, error) {
...
func (q *Queries) SoftDeleteAdmin(ctx context.Context, id pgtype.UUID) error {
